...
const style = {
    ...
    coverPhotoContainer: `flex items-center justify-center h-[20vh] overflow-hidden`, //h-[15vh] originally
...
const ProfileHeader = () => {
    ...
    <div className={style.wrapper}>
        ...
        <div className={style.coverPhotoContainer}>
            <img src={currentUser.coverImage} alt="cover" className={style.coverPhoto}/>
        </div>
        ...
        <div className={style.nav}>
             ...
             <div className="">Tweets & Replies</div>
